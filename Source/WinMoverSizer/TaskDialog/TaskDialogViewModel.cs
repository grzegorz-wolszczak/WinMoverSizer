...
public class TaskDialogViewModel : IActiveTaskDialog, INotifyPropertyChanged
{
    ...
    public string MainInstruction
    {
        ...
        set
        {
            ...
            RaisePropertyChangedEvent(nameof(MainInstruction));
        }
    }
    /// <summary>
    ...
    public bool ExpandedInfoVisible
    {
        ...
        set
        {
            ...
            RaisePropertyChangedEvent(nameof(ExpandedInfoVisible));
            RaisePropertyChangedEvent(nameof(ContentExpandedInfoVisible));
            RaisePropertyChangedEvent(nameof(FooterExpandedInfoVisible));
    ...
    public string VerificationText
    {
        ...
        set
        {
            ...
            RaisePropertyChangedEvent(nameof(VerificationText));
        }
    }
    /// <summary>
    ...
    public bool VerificationChecked
    {
        ...
        set
        {
            ...
            RaisePropertyChangedEvent(nameof(VerificationChecked));
    ...
    public string FooterText
    {
        ...
        set
        {
            ...
            RaisePropertyChangedEvent(nameof(FooterText));
        }
    }
    /// <summary>
    ...
    public VistaTaskDialogIcon MainIconType
    {
        ...
        set
        {
            ...
            RaisePropertyChangedEvent(nameof(MainIconType));
        }
    }
    /// <summary>
    /// Gets the main icon.
    ...
    public int DefaultButtonIndex
    {
        ...
        set
        {
            options.DefaultButtonIndex = value;
        }
    }
    /// <summary>
    ...
    public bool ProgressBarIndeterminate
    {
        ...
        private set
        {
            ...
            RaisePropertyChangedEvent(nameof(ShowProgressBar));
            RaisePropertyChangedEvent(nameof(ProgressBarIndeterminate));
        }
    }
    /// <summary>
    ...
    public double ProgressBarMinimum
    {
        ...
        private set
        {
            ...
            RaisePropertyChangedEvent(nameof(ProgressBarMinimum));
        }
    }
    /// <summary>
    ...
    public double ProgressBarMaximum
    {
        ...
        private set
        {
            ...
            RaisePropertyChangedEvent(nameof(ProgressBarMaximum));
        }
    }
    /// <summary>
    ...
    bool IActiveTaskDialog.SetExpandedInformation(string expandedInformation)
    {
        ...
        RaisePropertyChangedEvent(nameof(ContentExpandedInfo));
        RaisePropertyChangedEvent(nameof(FooterExpandedInfo));
    ...
    void IActiveTaskDialog.UpdateMainIcon(VistaTaskDialogIcon icon)
    {
        ...
        RaisePropertyChangedEvent(nameof(MainIconType));
        RaisePropertyChangedEvent(nameof(MainIcon));
    }
    ...
    void IActiveTaskDialog.UpdateFooterIcon(Icon icon)
    {
        ...
        RaisePropertyChangedEvent(nameof(FooterIcon));
    }
}
